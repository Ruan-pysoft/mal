...
Value_own value_atom(MutAtom_own atom, err_t ref err_out);
...
bool value_isatom(Value_ref this);
...
/* error with ERR_INVAL for !value_isatom(this) */
MutAtom_ref value_getatom(Value_ref this, err_t ref err_out);
